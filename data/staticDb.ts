...
export const STATIC_DB: DbSchema = {
  ...
  "workouts": [
    ...
    },
    {
      ...
      "rpe": 5,
      "trainingLoad": 64,
      "notes": "Jogged the First km, then ran progressively fast 2kms, Feeling ready for the 10km on Sunday.",
      "intervals": [
        {
          "reps": 1,
          "distance": 1000,
